...
<!-- Mirrored from demoxml.com/html/hotelbooking/accomodation.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 May 2024 09:19:47 GMT -->
<head>
        <meta charset="utf-8">
                                ...
                                <div class="room_thumb">
                                    ...
                                    <div class="room_details">
                                        ...
                                        <div class="room_block floatright">
                                            <a href="booking.html" class="btn btn-black">Đặt</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="hotel_booking margin-bottom-30">
                                        <form id="form1" role="form" action="#" class="">
                                                    ...
                                                    <div class="form-group col-lg-4 col-md-4 col-sm-4 icon_arrow">
                                                        <div class="input-group border-bottom-dark-2">
                                                            <select class="form-control" name="room" id="room">
                                                              <option selected="selected" disabled="disabled">Phòng</option>
                                                              <option value="Single">2 Phòng</option>
                                                              <option value="Double">3 Phòng</option>
                                                              <option value="Deluxe">4 Phòng</option>
                                                            </select>               
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-lg-4 col-md-4 col-sm-4 icon_arrow">
                                                        <div class="input-group border-bottom-dark-2">
                                                            <select class="form-control" name="room" id="adult">
                                                              <option selected="selected" disabled="disabled">Xếp hạng</option>
                                                              <option value="Single">Một sao</option>
                                                              <option value="Double">Hai sao</option>
                                                              <option value="Deluxe">Ba sao</option>
                                                            </select>               
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-lg-4 col-md-4 col-sm-4 icon_arrow">
                                                        <div class="input-group border-bottom-dark-2">
                                                            <select class="form-control" name="room" id="child">
                                                              ...
                                                              <option value="Single">1 Giường</option>
                                                              <option value="Double">3 Giường</option>
                                                              <option value="Deluxe">5 Giường</option>
                                                            </select>               
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group col-lg-2 col-md-2 col-sm-2">
                                                <div class="input-group range_slider">
                                                      <div data-role="rangeslider">
                                                        ...
                                                        <label>phạm vi:</label>
                                                        <div class="range">
                                                            <span class="floatleft">50đ</span><span class="floatright">5000đ</span>
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-2 clearfix">
                                                <a class="btn btn-warning btn-md floatright">Lọc</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            <div class="single_room_wrapper clearfix padding-bottom-30">
                                                <figure class="uk-overlay uk-overlay-hover">
                                                    ...
                                                    <div class="room_title border-bottom-whitesmoke clearfix">
                                                            <div class="left_room_title floatleft">
                                                                <h6>Phòng thanh lịch</h6>
                                                                <p>250đ/ <span>Tối</span></p>
                                                            </div>
                                                            <div class="left_room_title floatright">
                                                                <a href="booking.html" class="btn">Đặt</a>
                                                            </div>
                    ...
                    <div class="row">
                        <div class="container">
                            <div class="footer_copyright margin-tb-50 content-center">
                                <p>© 2015 <a href="#">Đặt phòng khách sạn</a>. Mọi quyền được bảo lưu</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from demoxml.com/html/hotelbooking/accomodation.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 May 2024 09:19:49 GMT -->
</html>
