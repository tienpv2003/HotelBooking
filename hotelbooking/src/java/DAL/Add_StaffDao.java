...
import Controllers.Customer.SignInServlet;
 ...
 * @author admin
 */
public class Add_StaffDao extends DBContext {
   ...
   public boolean changePasswordByEmail(String email, String newPassword) {
    ...
    private Staff authenticateStaff(String email, String password) throws SQLException, NoSuchAlgorithmException, Exception {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, Exception {
        Add_StaffDao dao = new Add_StaffDao();
        
        
        System.out.println(dao.authenticateStaff("mikizay175d@gmail.com", "111111").getEmail());
    }
}
