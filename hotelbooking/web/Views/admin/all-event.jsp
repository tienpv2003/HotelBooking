...
<html lang="vi">
            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <div class="mt-5">
                                <h4 class="card-title float-left mt-2">Tất cả sự kiện</h4>
                                <a href="create_event" class="btn btn-primary float-right veiwbutton">Thêm sự kiện</a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="datatable table table-stripped table table-hover table-center mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Tên sự kiện</th>
                                                <th>Giảm giá</th>
                                                <th style="width:50%">Miêu tả</th>
                                                <th>Trạng thái</th>
                                                <th class="text-right">Hành động</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <c:forEach var="i" items="${listEvent}">
                                                <tr>
                                                    <td>SK-${i.eventId}</td>
                                                    <td>${i.titleEvent}</td>
                                                    ...
                                                    <td>
                                                        <div class="actions">
                                                            <a href="#" class="btn btn-sm bg-success-light mr-2">${i.status}</a>
                                                        </div>
                                                    </td>
                                                    <td class="text-right">
                                                        <div class="dropdown dropdown-action">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a class="dropdown-item" href="#" onclick="confirmInactiveEvent(${i.eventId})">
                                                                    <i class="fas fa-trash-alt m-r-5"></i> Đóng sự kiện
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </td>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <h3 class="delete_class">Bạn có chắc chắn muốn đóng sự kiện này?</h3>
                    <div class="m-t-20">
    ...
    <script>
        function confirmInactiveEvent(eventId) {
            $('#confirmInactiveButton').attr('href', 'inactive_event?inEventId=' + eventId);
