            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title mt-5">Thêm Đặt phòng</h3> </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="row formtype">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="DP-0001"> </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Tên</label>
                ...
                <button type="button" class="btn btn-primary buttonedit1">Tạo Đặt phòng</button>
            </div>
        </div>
    </div>
