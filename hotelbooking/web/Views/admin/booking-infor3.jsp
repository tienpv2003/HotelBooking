                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 text-left">
                                                <c:if test="${mess != null}"><h3 class="alert alert-success"> ${mess} </h3></c:if> 
                                                <c:set var="c" value="${sessionScope.cusBooking}"></c:set>
                                                    ...
                                                    <li><strong>Số điện thoại:</strong> 
                                                        <c:if test="${empty c.phone}">Chưa có SĐT</c:if>
                                        ...
                                        <form action="booking_room_staff_3" method="post">
                                            <div class="row">
