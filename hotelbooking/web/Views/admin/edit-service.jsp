            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col text-center">
                        <h3 class="page-title mt-2">Cập nhật dịch vụ</h3> 
                    </div>
                </div>
            </div>
            <c:set var="event" value="${requestScope.service}"></c:set>
            <div class="row mt-3 justify-content-center">
                <div class="col-lg-8">
                    <c:if test="${not empty messageService}">
    <div class="alert alert-success">${messageService}</div>
</c:if>  
    ...
    <div class="alert alert-danger">${messageServiceError}</div>
                    ...
                    <div class="form-container">
                        <div class="form-content">
                            <form action="update_service" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="service_id" value="${service.serviceId}">
                                <div class="form-group">
                                    <label for="name_service">Tên dịch vụ</label>
                                    <input class="form-control" type="text" id="name_service" name="name_service" value="${service.nameService}" readonly >
                                </div>
                                <div class="form-group">
                                    <label for="title">Tiêu đề</label>
                                    <input class="form-control" type="text" id="title" name="title" value="${service.titleService}">
                                </div>
                                <div class="form-group">
                                    <label for="price">Giá dịch vụ</label>
                                    <input class="form-control" type="text" id="price" name="price" value="${service.priceService}">
                                </div>
                                <div class="form-group">
                                    <label for="description">Mô tả</label>
                                    <textarea cols="30" rows="4" class="form-control" id="description" name="description">${service.description}</textarea>
                                </div>
                                <div class="form-group">
                        ...
                        <img id="previewImg" src="" alt="Image preview" style="max-width: 100%; height: auto; display: none;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status" id="event_active" value="active" <c:if test="${service.status == 'active'}">checked</c:if>>
                                        <label class="form-check-label" for="event_active"> Kích hoạt </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status" id="event_inactive" value="inactive" <c:if test="${service.status == 'inactive'}">checked</c:if>>
                                ...
                                <div class="form-buttons">
                                    ...
                                    <button type="submit" class="btn btn-primary buttonedit1 mt-4">Cập nhật dịch vụ</button>
                                </div>
                            </form>
                        </div>
                    </div>
