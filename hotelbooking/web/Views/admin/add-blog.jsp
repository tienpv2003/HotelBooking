                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <h3 class="page-title mt-2 text-center font-weight-bolder">Thêm Tin Tức</h3>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row mt-3">
                    <div class="col-lg-12">
                        <div class="form-container">
                            <form action="add_news" method="post" enctype="multipart/form-data" onsubmit="return validateFileType()">
                                ...
                                <input type="submit" value="Đăng bài" class="btn btn-primary mt-4">
                            </form>
                        </div>
                    </div>
                </div>
