    ...
    <body>
        ...
        <jsp:include page="layout/sidebar.jsp"></jsp:include>
            <div class="page-wrapper">
                ...
                <form action="create_type_room" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="nametype">Tên loại phòng</label>
                        <input id="nametype" class="form-control" type="text" name="nametype" required placeholder="Nhập tên loại phòng">
                    </div>
                    <div class="form-group">
                        <label for="currentPrice">Giá tiền</label>
                        <input id="currentPrice" class="form-control" type="number" name="currentPrice" required step="0.1">
                    </div>
                    <div class="form-group">
                        <label for="title">Tiêu đề</label>
                        <input id="title" class="form-control" type="text" name="title" required placeholder="Nhập tiêu đề">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="contentdescription">Miêu tả Chi tiết</label>
                        <textarea id="contentdescription" class="form-control" name="contentdescription" required rows="4"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary buttonedit1">Thêm loại phòng</button>
                </form>
            </div>
        </div>
