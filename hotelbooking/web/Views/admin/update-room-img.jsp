...
<html lang="vi">
    ...
    <jsp:include page="layout/sidebar.jsp"></jsp:include>
        <div class="page-wrapper">
            <div class="content mt-5">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title mt-2">Chỉnh sửa ảnh phòng</h3> 
                        </div>
                    </div>
                </div>
            ...
            <div class="row mt-3">
                <div class="col-lg-12">
                    <form action="update_room_img" method="post" enctype="multipart/form-data">
                        <div class="row formtype">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Tên Phòng</label>
                                    <input value="${room.roomName}" class="form-control" type="text" name="name" disabled="">   
                                    <input type="hidden" name="roomId" class="form-control" value="${room.roomId}">
                                </div>
                            </div>                          
                            <div class="col-md-8">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <button type="button" onclick="cancelEdit(${room.roomId})" class="btn btn-secondary buttonedit1 mt-4" style="margin-right: 12px">Quay lại</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
                                ...
                                function cancelEdit(roomId) {
                                    window.location.href = 'room_detail?id=' + roomId;
                                }
    </script>
</body>
</html>