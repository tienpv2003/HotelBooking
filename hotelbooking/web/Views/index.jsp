...
<html lang="en">
    ...
    <!-- Mirrored from demoxml.com/html/hotelbooking/index-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 May 2024 09:18:57 GMT -->
    <head>
        <meta charset="utf-8">
        ...
        <!-- uikit -->
        <link rel="stylesheet" href="Views/css/uikit.min.css" />
        ...
        <!-- rev slider -->
        <link rel="stylesheet" href="Views/css/rev-slider/settings.css" />
        <!-- lightslider -->
        <link rel="stylesheet" href="Views/css/lightslider.css">
        <!-- Theme -->
    ...
    <body id="home_two">
                        ...
                        <div class="header_top clearfix">
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="left_header_top">
                                    <ul>
                                        <li><a href="#"><img src="img/temp-icon.png" alt="temp-icon">London dc, GR 17Â°C</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 floatright">
                                <div class="right_header_top clearfix floatright">
                                    <ul class="nav navbar-nav">
                                        <li class="">
                                            <a class="border-right-dark-4" href="signin">Sign In</a></li>
                                        <li class="">
                                            <a class="border-right-dark-4" href="signup">Sign Up</a></li> 
                                        </ul>
                                    ...
                                    <li class="">
                                            <a class="border-right-dark-4" href="logout">Log Out</a></li>
                ...
                <div class="another_facitilies clearfix padding-bottom-100">
                    <div class="col-lg-3 col-md-3 col-sm-3">
                        <div class="single_facities">
                            ...
                            <h6><c:if test="${not empty successMessage}">
                    ...
                    <div class="row">
                        <div class="container">
                            <div class="footer_copyright margin-tb-50 content-center">
                                <p>Â© 2015 <a href="#">Hotelbooking</a>. All rights reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- jquery library -->
        <script src="Views/js/vendor/jquery-1.11.2.min.js"></script>
        <!-- bootstrap -->
        <script src="Views/js/bootstrap.min.js"></script>

        <!-- uikit -->
        <script src="Views/js/uikit.min.js"></script>
        <!-- easing -->
        ...
        <!-- rev slider -->
        <script src="Views/js/rev-slider/rs-plugin/jquery.themepunch.plugins.min.js"></script>
        <script src="Views/js/rev-slider/rs-plugin/jquery.themepunch.revolution.js"></script>
        <script src="Views/js/rev-slider/rs.home.js"></script>
        <!-- wow Animation -->
    ...
    <!-- Mirrored from demoxml.com/html/hotelbooking/index-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 May 2024 09:19:14 GMT -->
</html>
