                                        ...
                                        <section class="welcome_area">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="welcome">
                                                    ...
                                                    <div class="row">
                                                        <c:set var="booking" value="${sessionScope.listBooking}"></c:set>
                                                        <c:forEach items="${booking.listItem}" var="t">
                                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                                <div class="single_room_wrapper clearfix">
                                                                    <div class="room_wrapper">
                                                                        <div class="room_media">
                                                                            <a href="#"><img src="Views/client/img/${t.room.roomType.roomtype_img}" alt=""></a>
                                                                        </div>
                                                                        <div class="room_title clearfix">
                                                                            ...
                                                                            <div class="left_room_title floatright">
                                                                                <a href="booking_service?roomId=${t.room.roomId}" class="btn">Thêm Dịch Vụ</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="section_title content-left margin-top-50 margin-bottom-30">
                                                        <h5>Tổng tiền:  <fmt:formatNumber value="${booking.calculateTotalPriceNotEvent()}" type="number" groupingUsed="true" />VND</h5>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12">
                                                            <div class="booking_next_btn padding-top-30 margin-top-20 clearfix border-top-whitesmoke">
                                                                <a href="booking_step_3" class="btn btn-warning btn-sm floatright"> Tiếp</a>
                                                                <a style="margin-right: 10px" href="booking_step_1?typeId=${requestScope.roomType.roomTypeId}" class="btn btn-warning btn-sm floatright"> Quay lại</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-body text-center">
                            ...
                            <div class="service-selection">
                                ...
                                <form action="booking_service" method="post">
                                    ...
                                    <input type="submit" value="Thêm dịch vụ" class="btn btn-create">
