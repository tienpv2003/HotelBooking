    ...
    <jsp:include page="layout/header.jsp"></jsp:include>
        ...
        <div class="container bootstrap snippets bootdey" style="margin-top: 20px;">
            <div class="panel panel-default">
                ...
                <c:set value="${sessionScope.listBookingFlex}" var="flex"></c:set> 
                ...
                <div class="row">
                    ...
                    <c:set value="${sessionScope.cusObj}" var="customer"></c:set>
                        <form action="payment_all_type_room" method="post">
                                    ...
                                    <table border="0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="money"><fmt:formatNumber value="${total}" type="number" groupingUsed="true" /> VND</td>
                                        </tr>
                                        <tr>
                                            <td class="typemoney"><strong>Giảm giá sự kiện: </strong></td>
                                            <td class="money"><fmt:formatNumber value="${event}" type="number" groupingUsed="true" />%</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="typemoney"><strong>Giảm giá khách (${customer.typeCustomer.typeCustomerName}): </strong></td>
                                            <td class="money"><fmt:formatNumber value="${customer.typeCustomer.discount}" type="number" groupingUsed="true" />%</td>
                                        </tr>
                                        <tr>
                                            <td class="typemoney"><strong>Tổng tiền:</strong></td>
                                            <td class="money"><fmt:formatNumber value="${endTotal}" type="number" groupingUsed="true" /> VND</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="text-align: right;">
                                                <input type="hidden" name="totalAmount" value="${endTotal}">
                                                ...
                                                <input type="hidden" name="txt_billing_mobile" value="${customer.phone}">
                                                <input type="hidden" name="txt_billing_email" value="${customer.email}">
                                                <input type="hidden" name="txt_billing_fullname" value="Vu Dinh Tu">
                                                <input type="hidden" name="txt_inv_addr1" value="${customer.address}">
                                                <input type="hidden" name="txt_bill_city" value="${customer.address}">
                                                <input type="hidden" name="txt_bill_country" value="VN">
                                                <input type="hidden" name="txt_bill_state" value="">
                                                <input type="hidden" name="txt_inv_mobile" value="${customer.phone}">
                                                <input type="hidden" name="txt_inv_email" value="${customer.email}">
                ...
                createOrder: function (data, actions) {
                    return actions.order.create({
                        ...
                        payer: {
                            ...
                            email_address: "vinhtien123456@gmail.com",
                            phone: {
                                phone_type: "MOBILE",
                                phone_number: {
