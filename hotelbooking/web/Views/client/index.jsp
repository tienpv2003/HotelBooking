...
<html lang="vi">
    ...
    <!-- Mirrored from demoxml.com/html/hotelbooking/index.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 May 2024 09:19:41 GMT -->
    <head>
        <meta charset="utf-8">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 floatright">
                                <div class="right_header_top clearfix floatright">
                                    <ul class="nav navbar-nav navbar-right">
                                        <li>   <a class="border-right-dark-4" href="signin">Đăng nhập</a></li>
                                        <li>   <a class="border-right-dark-4" href="signup">Đăng kí</a></li>
                                        <li>   <a class="border-right-dark-4" href="logout">Đăng xuất</a></li>
                                        ...
                                        <div class="dropdown">
                                            <button id="dLabel" type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                Welcome ${userGoogle.getLastName()} 
                            ...
                            <nav class="navbar navbar-default">
                                ...
                                <div class="navbar-header">
                                    ...
                                    <div class="site_logo fix">
                                        <a id="brand" class="clearfix navbar-brand" href="index.jsp"><img src="Views/client/img/site-logo.png" alt="Trips"></a>
                                ...
                                <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                                    <ul class="nav navbar-nav">
                                        <li role="presentation" class="dropdown">
                                            <a id="drop-one" href="index.jsp" class="dropdown-toggle">
                                                Trang chủ
                                            </a>
                                        ...
                                        <li><a href="accomodation.jsp">Chỗ ở</a></li>
                                        <li><a href="gallery.jsp">Phòng trưng bày</a></li>
                                        <li role="presentation" class="dropdown">
                                            <a id="drop2" href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false">
                                                Đặc trưng
                                            </a>
                                            <ul id="menu2" class="dropdown-menu" role="menu">Chỗ ở
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="about-us.jsp">Về chúng tôi</a></li>
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="booking.jsp">Đặt trước</a></li>
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="room-details.jsp">Chi tiết phòng</a></li>
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="staff.jsp">Nhân viên của chúng tôi</a></li>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                            <a href="booking.jsp" class="btn btn-primary floatright">Đặt</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                ...
                                <figure class="uk-overlay uk-overlay-hover">
                                    ...
                                    <div class="room_title border-bottom-whitesmoke clearfix">
                                        ...
                                        <div class="left_room_title floatright">
                                            <a href="booking.jsp" class="btn">Đặt</a>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="single_content clearfix border-bottom-whitesmoke">
                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-4 padding-left-0">
                                                <div class="post_media">
                                                    <a href="blog.jsp"><img src="Views/client/img/news-one.jpg" alt=""></a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="single_content clearfix margin-top-35 border-bottom-whitesmoke">
                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-4 padding-left-0">
                                                <div class="post_media">
                                                    <a href="blog.jsp"><img src="Views/client/img/news-two.jpg" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-8 padding-left-0">
                                                <div class="post_title clearfix">
                                        ...
                                        <div class="single_content clearfix margin-bottom-35 margin-top-35">
                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-4 padding-left-0">
                                                <div class="post_media">
                                                    <a href="blog.jsp"><img src="Views/client/img/news-three.jpg" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-8 padding-left-0">
                                                <div class="post_title clearfix">
    ...
    <!-- Mirrored from demoxml.com/html/hotelbooking/index.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 May 2024 09:19:47 GMT -->
</html>
