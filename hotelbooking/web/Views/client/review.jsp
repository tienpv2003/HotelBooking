            ...
            <div class="container">
                <div class="row">
                    ...
                    <c:set var="cus" value="${sessionScope.cusObj}"></c:set>
                        <form method="post" action="add_review" role="form">
                            <div class="form-group">
                                ...
                                <div style="display: flex">
                                    ...
                                    <p><strong>${cus.firstName} ${cus.lastName}</strong></p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="description">Đánh giá</label>
                            <textarea style="height: 150px" class="form-control bcontent" name="description" placeholder="Ghi đánh giá ở đây..." required></textarea>
                        </div>
                        <div class="form-group">
                            <input value="${roomTypeId}" name="roomTypeId" type="hidden"/>
                            <input type="submit" name="Submit" style="width: 100px; height: 40px" value="Đăng" class="btn btn-primary form-control" />
