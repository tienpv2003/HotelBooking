...
<!-- Mirrored from demoxml.com/html/hotelbooking/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 May 2024 09:19:53 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="container">
                <div class="our_room_facilities margin-bottom-70">
                    <div class="facilities_top_para">
                        <p>
                            Luôn luôn và cuộc sống đau đớn msan. Cras interdum hendreritnia Phasellus accumsan rna vitae molestie interdum. Vì anh ta đầu tư thoải mái nhưng gánh nặng không được khấu trừ. Ngày mai và công bằng và ủng hộ euismod hoặc cần giường. Bấy giờ các xe của cung, lớp gối, các xe của cung bây, gối hay cửa. Hãy sống lâu cùng con cháu chúng ta.
                        </p>
                    </div>
                    <div class="facilities_main_part">
                        <div class="section_title margin-top-80 margin-bottom-35">
                            <h5>Tiện nghi phòng của chúng tôi</h5>
                        </div>
                        <div class="row">
                            <div class="facilities_name clearfix margin-bottom-45">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-1 col-xs-12">
                                    <div class="single_facilities_name clearfix">
                                        <a href="#" class="btn btn-warning btn-md">Phòng sách</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="hotel_stuff">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="section_title margin-bottom-40">
                                        <h5>Nhân viên khách sạn của chúng tôi</h5>
                                    </div>
                                </div>
                                        ...
                                        <div class="single_staff">
                                            <figure class="uk-overlay uk-overlay-hover">
                                                ...
                                                <div class="uk-overlay-panel uk-overlay-background single_staff_details">
                                                    ...
                                                    <p>
                                                        Luôn luôn và cuộc sống đau đớn msan. 
                                                    </p>
...
<!-- Mirrored from demoxml.com/html/hotelbooking/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 May 2024 09:19:56 GMT -->
</html>
