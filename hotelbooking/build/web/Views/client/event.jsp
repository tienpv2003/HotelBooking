            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="breadcrumb_main" style="
                         ...
                         padding-bottom: 0px;
                         ">
                        <h2 style="color: #313a45">Sự kiện</h2>
                    </div>
                </div>
            </div>            
        </section>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <c:forEach items="${listeventclient}" var="events">
                                <div class="col-md-4 col-sm-6 col-xs-12 margin-bottom-30">
                                    <div class="single_blog_style1 ${events.status == 'inactive' ? 'inactive-event' : ''}">
                                        <div class="style_blog_img_box">
                                            <img src="Views/client/img/${events.image}" alt="img" class="responsive-img" />
                                            <a class="style_b_link" href="#"><i class="fa fa-link"></i></a>
                                        </div>
                                        <div class="at_love"><i class="fa fa-heart"></i></div>
                                        <div class="blog_text_box">
                                            <h5>${events.titleEvent}</h5>
                                            <ul class="clearfix">
                                                <li>${events.startDate} | ${events.endDate}</li>
                                            </ul>
                                            <p>${events.description}</p>
                                            <c:if test="${events.status == 'inactive'}">
                                                <p style="color: red;">Hết hạn</p>
                                            </c:if>
                                            <a href="event_detail_client?eventId=${events.eventId}">Đọc thêm</a>
                                        </div>
                                    </div>
                                </div>
                            </c:forEach>
...
.style_blog_img_box {
        ...
        .inactive-event {
            opacity: 0.5; /* Làm mờ đi khi sự kiện không hoạt động */
        }
