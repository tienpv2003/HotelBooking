                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col text-center">
                                ...
                                <h3 class="page-title mt-2">Thêm Tiện ích</h3> 
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3 justify-content-center">
                        ...
                        <div class="form-container">
                            <div class="form-content">
                                <form action="add_convenient" method="post">
                                    <div class="form-group">
                                        <label for="name_convenient">Tên Tiện ích</label>
                                        <input class="form-control" type="text" id="name_service" name="name" required> 
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary buttonedit1 mt-4">Thêm Tiện ích</button>
                                </form>
                            </div>
                        </div>
                    </div>
