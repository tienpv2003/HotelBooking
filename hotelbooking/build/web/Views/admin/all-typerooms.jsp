...
<html lang="vi">
    ...
    <jsp:include page="layout/sidebar.jsp"></jsp:include>
            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <div class="mt-5">
                                <h4 class="card-title float-left mt-2">Tất cả loại phòng</h4>
                                <a href="create_type_room" class="btn btn-primary float-right veiwbutton">Thêm loại phòng</a>
                            </div>
                                                    ...
                                                    <td class="text-right">
                                                        <div class="dropdown dropdown-action">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a class="dropdown-item" href="update_type_room?id=${c.roomTypeId}">
                                                                    <i class="fas fa-pencil-alt m-r-5"></i>Chỉnh sửa
                                                                </a>
                                                                    <a class="dropdown-item" href="room_detail?id=${c.roomTypeId}">
                                                                               <i class="fas fa-info-circle"></i> Thông tin chi tiết
                                                                            </a>
                                                                <c:if test="${c.status == 'active'}">
                                                                    <a class="dropdown-item" href="#" onclick="confirmDeactivate(${c.roomTypeId})" data-toggle="modal" data-target="#inactive_asset">
                                                                        <i class="far fa-window-close"></i> Dừng hoạt động
                                                                    </a>
                                                                </c:if>
                                                                ...
                                                                <a class="dropdown-item" href="#" onclick="confirmDelete(${c.roomTypeId})" data-toggle="modal" data-target="#delete_asset">
        ...
        <div id="inactive_asset" class="modal fade delete-modal" role="dialog">
            <form action="all_type_room" method="post">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body text-center">
                            <img src="Views/Login/img/logo-chot.jpg" alt="" width="50" height="46">
                            <h3 class="delete_class">Bạn có chắc muốn dừng hoạt động của loại phòng này ?</h3>
                            <input type="hidden" name="roomTypeId" id="inactiveRoomTypeId">
            ...
            <form action="all_type_room" method="post">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body text-center">
                            <img src="Views/Login/img/logo-chot.jpg" alt="" width="50" height="46">
                            <h3 class="delete_class">Bạn có chắc muốn xóa loại phòng này?</h3>
    ...
    <script>
                                                                    ...
                                                                    function confirmDelete(id) {
                                                                        document.getElementById('deleteRoomTypeId').value = id;
                                                                    }
    </script>
</body>
</html>
