            ...
            <div class="page-wrapper">
                <div class="content mt-5">
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col text-center">
                                <h3 class="page-title mt-2">Thêm sự kiện</h3> 
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3 justify-content-center">
                        ...
                        <c:if test="${not empty requestScope.messageEvent}">
                            <div class="alert alert-success" role="alert">
                                ${requestScope.messageEvent}
                            </div>
                        </c:if>
                        ...
                        <div class="form-container">
                            <div class="form-content">
                                <form action="create_event" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label>Tiêu đề</label>
                                        <input class="form-control" type="text" name="titleEvent" > 
                                    </div>
                                    <!--                                <div class="form-group">
                                                                        ...
                                                                        <img id="previewImg" src="" alt="Image preview" style="max-width: 100%; height: auto; display: none; margin-top: 10px;"/>
                                                                    </div>-->
                                    ...
                                    <div class="form-buttons">
                                        ...
                                        <button type="submit" class="btn btn-primary buttonedit1 mt-4">Thêm sự kiện</button>
                                    </div>
                                </form>
                            </div>
                        </div>
