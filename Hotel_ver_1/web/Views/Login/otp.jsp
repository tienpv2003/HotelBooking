                ...
                <div class="row justify-content-center">
                    <div class="col-md-7 col-lg-5">
                        <div class="login-wrap p-4 p-md-5">
                            ...
                            <form action="otp" method="post" class="login-form">
                                <div class="form-group">
                                    <input type="number" name="otp"class="form-control rounded-left" <c:if test="${otp != null}">value="${otp}"</c:if> placeholder="Enter OTP" required>
                                </div>
                                ...
                                <div class="form-group d-md-flex">
                                    <div class="w-60 text-md-left">
                                        <a href="ForgotServlet">Back to log in</a>
                                    </div>
                                </div>
                            </form>
                        </div>
